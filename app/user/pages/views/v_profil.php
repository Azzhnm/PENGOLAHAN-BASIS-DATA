                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="Kelas">
                                    ...
                                    <option disabled>------------------------------------------</option>
                                                                <!-- FIK -->
                                                                <option value="FIK - D3 Teknik Informatika">FIK - D3 Teknik Informatika</option>
                                                                <option value="FIK - D3 Manajemen Informatika">FIK - D3 Manajemen Informatika</option>
                                                                <option value="FIK - Teknik Komputer">FIK - Teknik Komputer</option>
                                                                <option value="FIK - Informatika">FIK - Informatika</option>
                                                                <option value="FIK - Teknologi Informasi">FIK - Teknologi Informasi</option>
                                                                <option value="FIK - Sistem Informasi">FIK - Sistem Informasi</option>
                                                                <!-- FES -->
                                                                <option disabled>------------------------------------------</option>
                                                                <option value="FES - Akuntansi">FES - Akuntansi</option>
                                                                <option value="FES - Ilmu Komunikasi">FES - Ilmu Komunikasi</option>
                                                                <option value="FES - Ekonomi">FES - Ekonomi</option>
                                                                <option value="FES - Hubungan Internasional">FES - Hubungan Internasional</option>
                                                                <option value="FES - Ilmu Pemerintahan">FES - Ilmu Pemerintahan</option>
                                                                <option value="FES - Kewirausahaan">FES - Kewirausahaan</option>
                                                                <!-- FST -->
                                                                <option disabled>------------------------------------------</option>
                                                                <option value="FST - Arsitektur">FST - Arsitektur</option>
                                                                <option value="FST - Geografi">FST - Geografi</option>
                                                                <option value="FST - Perencanaan Wilayah dan Kota">FST - Perencanaan Wilayah dan Kota</option>
                                                            </select>
                            </div>
                            <div class="form-group">
